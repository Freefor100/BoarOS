...
#define RISCV_SSTATUS_FS_MASK 0x6000
#define RISCV_SSTATUS_FS_INITIAL 0x2000
#define RISCV_SSTATUS_FS_CLEAN 0x4000
#define RISCV_SSTATUS_FS_DIRTY 0x6000
...
#define RISCV_SCAUSE_INSTRUCTION_PAGE_FAULT 12
